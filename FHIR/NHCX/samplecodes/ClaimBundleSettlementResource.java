...
public class ClaimBundleSettlementResource {
	...
	public static void main(String[] arg) throws Exception {
		...
		Bundle ClaimResourceBundle = populateClaimBundleSettlementResource(scanner);
		...
		if (validator(ClaimResourceBundle)) {
			...
			// Enter file path (Eg: C://generatedexamples//ClaimBundle.json)
			...
			String serializeBundle = parser.encodeResourceToString(ClaimResourceBundle);
		...
		{
			System.out.println("Failed to validate populated ClaimResourceBundle");
		}
	}

	// populating ClaimBundle Resource
	public static Bundle populateClaimBundleSettlementResource(Scanner scanner) {

		Bundle claimBundle = new Bundle();

		// set Id - Logical id of this artifact
		claimBundle.setId("ClaimBundle-settlement-example-01");
		...
		//set Identifier
		claimBundle.setIdentifier(new Identifier().setSystem("http://hip.in").setValue("bc3c6c57-2053-4d0e-ac40-139ccccff645"));

		// set Type - collection
		claimBundle.setType(BundleType.COLLECTION);

		// set Timestamp - When the bundle was assembled
		claimBundle.setTimestampElement(new InstantType("2023-12-30T11:01:00+05:00"));
		...
		bundleEntry1.setFullUrl("urn:uuid:4776dbdf-d596-4cd1-9966-9d44ae9dec0b");
		bundleEntry1.setResource(ResourcePopulator.populateClaimSettlementResource());
		...
		bundleEntry7.setFullUrl("urn:uuid:acefdfbd-e612-483e-90fc-a5c44d09a4b9");
		bundleEntry7.setResource(ResourcePopulator.populateSecondMedicationRequestResource());


		BundleEntryComponent bundleEntry8 = new BundleEntryComponent();
		bundleEntry8.setFullUrl("urn:uuid:bdaebfe7-8296-4241-9629-b16c364a10b4");
		...
		bundleEntry9.setFullUrl("urn:uuid:7aace234-5172-4126-a907-ace8745bd1a5");
		bundleEntry9.setResource(ResourcePopulator.populateClaimEnhancementResource());

		BundleEntryComponent bundleEntry10 = new BundleEntryComponent();
		bundleEntry10.setFullUrl("urn:uuid:760ec93e-7ec8-4e82-b8a3-fe6512fccd8b");
		bundleEntry10.setResource(ResourcePopulator.populateClaimPreauthResource());
		...
		bundleEntry11.setResource(ResourcePopulator.populateSecondDocumentReferenceResource());
		...
		bundleEntry12.setResource(ResourcePopulator.populateThirdDocumentReferenceResource());
