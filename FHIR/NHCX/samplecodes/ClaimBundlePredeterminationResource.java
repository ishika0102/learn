...
public class ClaimBundlePredeterminationResource {
	...
	public static void main(String[] arg) throws Exception {
		...
		Bundle ClaimResourceBundle = populateClaimBundlePredeterminationResource(scanner);
	...
	public static Bundle populateClaimBundlePredeterminationResource(Scanner scanner) {

		Bundle claimBundle = new Bundle();

		// set Id - Logical id of this artifact
		claimBundle.setId("ClaimBundle-predetermination-example-01");
		...
		claimBundle.setTimestampElement(new InstantType("2023-12-11T15:32:26.605+05:30"));
		...
		bundleEntry1.setFullUrl("urn:uuid:d5563407-e461-41f2-8952-405d26b50b42");
		bundleEntry1.setResource(ResourcePopulator.populateClaimPredeterminationResource());
		...
		bundleEntry9.setFullUrl("urn:uuid:514bcad3-7bf0-43a0-b566-e8ecd815dc91");
		bundleEntry9.setResource(ResourcePopulator.populateThirdDocumentReferenceResource());
