...
public class ClaimResponseBundlePreauthResource {
	...
	public static void main(String[] arg) throws Exception {
		...
		Bundle ClaimResponseResourceBundle = populateClaimResponseBundlePreauthResource(scanner);
	...
	// Populate Bundle
	public static Bundle populateClaimResponseBundlePreauthResource(Scanner scanner) {

		Bundle claimResponseBundle = new Bundle();

		// set Id - Logical id of this artifact
		claimResponseBundle.setId("ClaimResponseBundle-preauth-example-01");
		...
		System.out.println();
		bundleEntry1.setFullUrl("urn:uuid:9c29282a-6239-4ef1-92ad-742a1ebe1120");
		bundleEntry1.setResource(ResourcePopulator.populateClaimResponsePreauth());
		...
		bundleEntry7.setFullUrl("urn:uuid:760ec93e-7ec8-4e82-b8a3-fe6512fccd8b");
		bundleEntry7.setResource(ResourcePopulator.populateClaimPreauthResource());
