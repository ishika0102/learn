...
public class TaskBundleForPaymentNoticeRequest {
	...
	public static void main(String[] arg) throws Exception {
		...
		Bundle TaskBundle = populateTaskBundleForPaymentNoticeRequest();
	...
	// populating TaskBundleForPaymentNoticeRequest Resource
	public static Bundle populateTaskBundleForPaymentNoticeRequest() {

		Bundle TaskBundle = new Bundle();

		// set Id - Logical id of this artifact
		TaskBundle.setId("TaskBundleForPaymentNoticeRequest-example-01");
		...
		bundleEntry0.setResource(ResourcePopulator.populateTaskResourceForPaymentNoticeRequest());

		BundleEntryComponent bundleEntry1 = new BundleEntryComponent();
		bundleEntry1.setFullUrl("urn:uuid:face34c9-1ffd-43b9-bd74-b5d1a0a95cca");
		bundleEntry1.setResource(ResourcePopulator.populatePaymentNoticeResource());
		...
		bundleEntry14.setFullUrl("urn:uuid:602907ed-ae0c-4170-b761-40e3a824546c");
		bundleEntry14.setResource(ResourcePopulator.populatePaymentReconciliation());
