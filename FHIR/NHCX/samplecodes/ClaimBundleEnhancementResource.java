...
public class ClaimBundleEnhancementResource {
	...
	public static void main(String[] arg) throws Exception {
		...
		Bundle ClaimResourceBundle = populateClaimBundleEnhancementResource(scanner);
	...
	public static Bundle populateClaimBundleEnhancementResource(Scanner scanner) {

		Bundle claimBundle = new Bundle();

		// set Id - Logical id of this artifact
		claimBundle.setId("ClaimBundle-enhancement-example-01");
		...
		claimBundle.setTimestampElement(new InstantType("2023-12-13T15:32:26.605+05:30"));
		...
		bundleEntry1.setFullUrl("urn:uuid:7aace234-5172-4126-a907-ace8745bd1a5");
		bundleEntry1.setResource(ResourcePopulator.populateClaimEnhancementResource());
		...
		bundleEntry10.setFullUrl("urn:uuid:e53fa5db-f676-4b16-a273-f4088866314e");
		bundleEntry10.setResource(ResourcePopulator.populateSecondDocumentReferenceResource());

		BundleEntryComponent bundleEntry11 = new BundleEntryComponent();
		bundleEntry11.setFullUrl("urn:uuid:514bcad3-7bf0-43a0-b566-e8ecd815dc91");
		bundleEntry11.setResource(ResourcePopulator.populateThirdDocumentReferenceResource());
