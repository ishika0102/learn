...
public class TaskBundleForReprocessRequest {
	...
	public static void main(String[] arg) throws Exception {
		...
		Bundle TaskBundle = populateTaskBundleForReprocessRequest();
	...
	// populating TaskBundleForReprocessRequest Resource
	public static Bundle populateTaskBundleForReprocessRequest() {

		Bundle TaskBundle = new Bundle();

		// set Id - Logical id of this artifact
		TaskBundle.setId("TaskBundleForReprocessRequest-example-01");
		...
		bundleEntry0.setResource(ResourcePopulator.populateTaskResourceForReprocessRequest());
