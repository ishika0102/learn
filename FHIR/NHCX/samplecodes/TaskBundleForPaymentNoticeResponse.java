...
public class TaskBundleForPaymentNoticeResponse {
	...
	public static void main(String[] arg) throws Exception {
		...
		Bundle TaskBundle = populateTaskBundleForPaymentNoticeResponse();
	...
	// populating TaskBundleForPaymentNoticeResponse Resource
	public static Bundle populateTaskBundleForPaymentNoticeResponse() {

		Bundle TaskBundle = new Bundle();

		// set Id - Logical id of this artifact
		TaskBundle.setId("TaskBundleForPaymentNoticeResponse-example-01");
		...
		bundleEntry0.setResource(ResourcePopulator.populateTaskResourceForPaymentNoticeResponse());
		...
		bundleEntry6.setFullUrl("urn:uuid:3bc96820-c7c9-4f59-900d-6b0ed1fa558e");
		bundleEntry6.setResource(ResourcePopulator.populatePractitionerResource());
