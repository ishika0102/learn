...
public class ClaimResponseBundleEnhancementResource {
	...
	public static void main(String[] arg) throws Exception {
		...
		Bundle ClaimResponseResourceBundle = populateClaimResponseBundleEnhancementResource(scanner);
	...
	// Populate Bundle
	public static Bundle populateClaimResponseBundleEnhancementResource(Scanner scanner) {

		Bundle claimResponseBundle = new Bundle();

		// set Id - Logical id of this artifact
		claimResponseBundle.setId("ClaimResponseBundle-enhancement-example-01");
		...
		System.out.println();
		bundleEntry1.setFullUrl("urn:uuid:8128e312-dc27-4e1f-ad02-0882e37187c0");
		bundleEntry1.setResource(ResourcePopulator.populateClaimResponseEnhancement());
		...
		bundleEntry7.setFullUrl("urn:uuid:7aace234-5172-4126-a907-ace8745bd1a5");
		bundleEntry7.setResource(ResourcePopulator.populateClaimEnhancementResource());

		BundleEntryComponent bundleEntry8 = new BundleEntryComponent();
		bundleEntry8.setFullUrl("urn:uuid:760ec93e-7ec8-4e82-b8a3-fe6512fccd8b");
		bundleEntry8.setResource(ResourcePopulator.populateClaimPreauthResource());

		BundleEntryComponent bundleEntry9 = new BundleEntryComponent();
		bundleEntry9.setFullUrl("urn:uuid:acefdfbd-e612-483e-90fc-a5c44d09a4b9");
		bundleEntry9.setResource(ResourcePopulator.populateSecondMedicationRequestResource());

		BundleEntryComponent bundleEntry10 = new BundleEntryComponent();
		bundleEntry10.setFullUrl("urn:uuid:bdaebfe7-8296-4241-9629-b16c364a10b4");
		bundleEntry10.setResource(ResourcePopulator.populateSecondConditionResource());

		BundleEntryComponent bundleEntry11 = new BundleEntryComponent();
		bundleEntry11.setFullUrl("urn:uuid:e53fa5db-f676-4b16-a273-f4088866314e");
		...
		bundleEntry12.setFullUrl("urn:uuid:514bcad3-7bf0-43a0-b566-e8ecd815dc91");
