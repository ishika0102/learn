...
public class ClaimResponseBundlePredeterminationResource {
	...
	public static void main(String[] arg) throws Exception {
		...
		Bundle ClaimResponseResourceBundle = populateClaimResponseBundlePredeterminationResource(scanner);
	...
	// Populate Bundle
	public static Bundle populateClaimResponseBundlePredeterminationResource(Scanner scanner) {

		Bundle claimResponseBundle = new Bundle();

		// set Id - Logical id of this artifact
		claimResponseBundle.setId("ClaimResponseBundle-predetermination-example-01");
		...
		claimResponseBundle.setTimestampElement(new InstantType("2023-12-12T15:32:26.605+05:30"));
		...
		System.out.println();
		bundleEntry1.setFullUrl("urn:uuid:dc7c8739-bb4f-4405-a483-bec3078628db");
		bundleEntry1.setResource(ResourcePopulator.populateClaimResponsePredetermination());
		...
		bundleEntry7.setFullUrl("urn:uuid:d5563407-e461-41f2-8952-405d26b50b42");
		bundleEntry7.setResource(ResourcePopulator.populateClaimPredeterminationResource());

		BundleEntryComponent bundleEntry8 = new BundleEntryComponent();
		bundleEntry8.setFullUrl("urn:uuid:acefdfbd-e612-483e-90fc-a5c44d09a4b9");
		bundleEntry8.setResource(ResourcePopulator.populateSecondMedicationRequestResource());
