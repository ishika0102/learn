...
/**
 * The ClaimResponseBundleResource class populates, validates, parse and serializes
 * Artifact - Claim
 */

public class ClaimResponseBundleSettlementResource {
	...
	public static void main(String[] arg) throws Exception {
		...
		Bundle ClaimResponseResourceBundle = populateClaimResponseBundleSettlementResource(scanner);
		...
		if (validator(ClaimResponseResourceBundle)) {
			...
			// Enter file path (Eg: C://generatedexamples//ClaimResponseBundle.json)
			...
			String serializeBundle = parser.encodeResourceToString(ClaimResponseResourceBundle);
		...
		{
			System.out.println("Failed to validate populated ClaimResponseResource bundle");
		}
	}

	// Populate Bundle
	public static Bundle populateClaimResponseBundleSettlementResource(Scanner scanner) {

		Bundle claimResponseBundle = new Bundle();

		// set Id - Logical id of this artifact
		claimResponseBundle.setId("ClaimResponseBundle-settlement-example-01");
		...
		claimResponseBundle.setMeta(meta);

		//set Identifier
		claimResponseBundle.setIdentifier(new Identifier().setSystem("http://hip.in").setValue("bc3c6c57-2053-4d0e-ac40-139ccccff645"));


		// set Type - collection
		claimResponseBundle.setType(BundleType.COLLECTION);

		// set Timestamp - When the bundle was assembled
		claimResponseBundle.setTimestampElement(new InstantType("2020-07-09T15:32:26.605+05:30"));

		// set Entry - Entry in the bundle - will have a resource or information
		List<Bundle.BundleEntryComponent> list = claimResponseBundle.getEntry();

		BundleEntryComponent bundleEntry1 = new BundleEntryComponent();
		System.out.println();
		bundleEntry1.setFullUrl("urn:uuid:83558c21-8bf4-46bf-b640-158bf385b1b5");
		bundleEntry1.setResource(ResourcePopulator.populateClaimResponseSettlement());
		...
		bundleEntry4.setFullUrl("urn:uuid:4a88bdc0-d320-4138-8014-d41913d9745a");
		...
		bundleEntry5.setFullUrl("urn:uuid:3bc96820-c7c9-4f59-900d-6b0ed1fa558e");
		bundleEntry5.setResource(ResourcePopulator.populatePractitionerResource());

		BundleEntryComponent bundleEntry6 = new BundleEntryComponent();
		bundleEntry6.setFullUrl("urn:uuid:0316e4d7-03e6-48b8-bcfd-8a3254f3f7b5");
		...
		bundleEntry7.setFullUrl("urn:uuid:4776dbdf-d596-4cd1-9966-9d44ae9dec0b");
		bundleEntry7.setResource(ResourcePopulator.populateClaimSettlementResource());

		BundleEntryComponent bundleEntry8 = new BundleEntryComponent();
		bundleEntry8.setFullUrl("urn:uuid:7aace234-5172-4126-a907-ace8745bd1a5");
		bundleEntry8.setResource(ResourcePopulator.populateClaimEnhancementResource());

		BundleEntryComponent bundleEntry9 = new BundleEntryComponent();
		bundleEntry9.setFullUrl("urn:uuid:760ec93e-7ec8-4e82-b8a3-fe6512fccd8b");
		bundleEntry9.setResource(ResourcePopulator.populateClaimPreauthResource());

		BundleEntryComponent bundleEntry10 = new BundleEntryComponent();
		bundleEntry10.setFullUrl("urn:uuid:acefdfbd-e612-483e-90fc-a5c44d09a4b9");
		...
		bundleEntry11.setFullUrl("urn:uuid:bdaebfe7-8296-4241-9629-b16c364a10b4");
		bundleEntry11.setResource(ResourcePopulator.populateSecondConditionResource());

		BundleEntryComponent bundleEntry12 = new BundleEntryComponent();
		bundleEntry12.setFullUrl("urn:uuid:e53fa5db-f676-4b16-a273-f4088866314e");
		bundleEntry12.setResource(ResourcePopulator.populateDocumentReferenceResource());

		BundleEntryComponent bundleEntry13 = new BundleEntryComponent();
		bundleEntry13.setFullUrl("urn:uuid:514bcad3-7bf0-43a0-b566-e8ecd815dc91");
		bundleEntry13.setResource(ResourcePopulator.populateDocumentReferenceResource());
        ...
        list.add(bundleEntry11);
		list.add(bundleEntry12);		
		list.add(bundleEntry13);



		claimResponseBundle.setEntry(list);
	...
	// Validation method will validate claimResponseBundle against ABDM ClaimResponseBundle FHIR
