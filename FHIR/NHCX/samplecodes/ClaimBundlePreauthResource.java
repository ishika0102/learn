...
public class ClaimBundlePreauthResource {
	...
	public static void main(String[] arg) throws Exception {
		...
		Bundle ClaimResourceBundle = populateClaimBundlePreauthResource(scanner);
	...
	public static Bundle populateClaimBundlePreauthResource(Scanner scanner) {
		...
		bundleEntry1.setFullUrl("urn:uuid:760ec93e-7ec8-4e82-b8a3-fe6512fccd8b");
		bundleEntry1.setResource(ResourcePopulator.populateClaimPreauthResource());
