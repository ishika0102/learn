...
public class TaskBundleForSearchResponse {
	...
	public static void main(String[] arg) throws Exception {
		...
		Bundle TaskBundle = populateTaskBundleForSearchResponse();
	...
	// populating TaskBundleForSearchResponse Resource
	public static Bundle populateTaskBundleForSearchResponse() {

		Bundle TaskBundle = new Bundle();

		// set Id - Logical id of this artifact
		TaskBundle.setId("TaskBundleForSearchResponse-example-01");
		...
		bundleEntry0.setResource(ResourcePopulator.populateTaskResourceForSearchResponse());
