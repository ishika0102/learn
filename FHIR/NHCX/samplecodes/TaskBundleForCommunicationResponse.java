...
public class TaskBundleForCommunicationResponse {
	...
	public static void main(String[] arg) throws Exception {
		...
		// Populate TaskBundle resource
		Bundle TaskBundle = populateTaskBundleForCommunicationResponse();
	...
	public static Bundle populateTaskBundleForCommunicationResponse() {

		Bundle TaskBundle = new Bundle();

		// set Id - Logical id of this artifact
		TaskBundle.setId("TaskBundleForCommunicationResponse-example-01");
		...
		bundleEntry0.setResource(ResourcePopulator.populateTaskResourceForCommunicationResponse());

		BundleEntryComponent bundleEntry1 = new BundleEntryComponent();
		bundleEntry1.setFullUrl("urn:uuid:2a89a8e5-28b4-4508-b96c-07904fe3b1d3");
		bundleEntry1.setResource(ResourcePopulator.populateCommunicationResource());

		BundleEntryComponent bundleEntry2 = new BundleEntryComponent();
		bundleEntry2.setFullUrl("urn:uuid:d137441d-e494-4c9f-a847-0c28eb1e31cc");
		bundleEntry2.setResource(ResourcePopulator.populateCommunicationRequestResource());

		BundleEntryComponent bundleEntry3 = new BundleEntryComponent();
		bundleEntry3.setFullUrl("urn:uuid:760ec93e-7ec8-4e82-b8a3-fe6512fccd8b");
		bundleEntry3.setResource(ResourcePopulator.populateClaimPreauthResource());
		...
		bundleEntry7.setFullUrl("urn:uuid:4a88bdc0-d320-4138-8014-d41913d9745a");
		bundleEntry7.setResource(ResourcePopulator.populateSecondOrganizationResource());

		BundleEntryComponent bundleEntry8 = new BundleEntryComponent();
		bundleEntry8.setFullUrl("urn:uuid:3bc96820-c7c9-4f59-900d-6b0ed1fa558e");
		bundleEntry8.setResource(ResourcePopulator.populatePractitionerResource());

		BundleEntryComponent bundleEntry9 = new BundleEntryComponent();
		bundleEntry9.setFullUrl("urn:uuid:0316e4d7-03e6-48b8-bcfd-8a3254f3f7b5");
		bundleEntry9.setResource(ResourcePopulator.populateCoverageResource());
