...
public class TaskBundleForReprocessResponse {
	...
	public static void main(String[] arg) throws Exception {
		...
		Bundle TaskBundle = populateTaskBundleForReprocessResponse();
	...
	// populating TaskBundleForReprocessResponse Resource
	public static Bundle populateTaskBundleForReprocessResponse() {

		Bundle TaskBundleForReprocessResponse = new Bundle();

		// set Id - Logical id of this artifact
		TaskBundleForReprocessResponse.setId("TaskBundleForReprocessResponse-example-01");
		...
		TaskBundleForReprocessResponse.setMeta(meta);

		TaskBundleForReprocessResponse.setIdentifier(new Identifier().setSystem("http://hip.in").setValue("bc3c6c57-2053-4d0e-ac40-139ccccff645"));

		// set Type - collection
		TaskBundleForReprocessResponse.setType(BundleType.COLLECTION);

		// set Timestamp - When the bundle was assembled
		TaskBundleForReprocessResponse.setTimestampElement(new InstantType("2023-09-07T15:32:26.605+05:30"));

		// set Entry - Entry in the bundle - will have a resource or information
		List<Bundle.BundleEntryComponent> list = TaskBundleForReprocessResponse.getEntry();
		...
		bundleEntry0.setResource(ResourcePopulator.populateTaskResourceForReprocessResponse());
		...
		bundleEntry2.setFullUrl("urn:uuid:4776dbdf-d596-4cd1-9966-9d44ae9dec0b");
		bundleEntry2.setResource(ResourcePopulator.populateClaimSettlementResource());
		...
		bundleEntry5.setFullUrl("urn:uuid:4a88bdc0-d320-4138-8014-d41913d9745a");
		bundleEntry5.setResource(ResourcePopulator.populateSecondOrganizationResource());

		BundleEntryComponent bundleEntry6 = new BundleEntryComponent();
		bundleEntry6.setFullUrl("urn:uuid:acefdfbd-e612-483e-90fc-a5c44d09a4b9");
		bundleEntry6.setResource(ResourcePopulator.populateSecondMedicationRequestResource());
		...
		bundleEntry10.setFullUrl("urn:uuid:7aace234-5172-4126-a907-ace8745bd1a5");
		bundleEntry10.setResource(ResourcePopulator.populateClaimEnhancementResource());

		BundleEntryComponent bundleEntry11 = new BundleEntryComponent();
		bundleEntry11.setFullUrl("urn:uuid:760ec93e-7ec8-4e82-b8a3-fe6512fccd8b");
		bundleEntry11.setResource(ResourcePopulator.populateClaimPreauthResource());
		...
		bundleEntry13.setResource(ResourcePopulator.populateSecondDocumentReferenceResource());
		...
		TaskBundleForReprocessResponse.setEntry(list);
